...
function Footer() {
    ...
    <a href="."><img class="footer__logo" src={blanco} alt="logotipo"/></a>
            <nav class="footer__nav">
                <ul class="footer__ul">
                    <li><a class="link" href=".">Adopta</a></li>
                    <li><a class="link responsive" href=".">Nosotros</a></li>
                    <li><a class="link" href=".">Tienda</a></li>
                    <li><a class="link responsive" href=".">Consultas</a></li>
            ...
            <div class="redes">
                ...
                <div class="redes-iconos">
                    <a class="link" href="."> <svg xmlns="http://www.w3.org/2000/svg"
